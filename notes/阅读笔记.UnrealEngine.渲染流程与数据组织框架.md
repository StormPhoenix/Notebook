...
关键点：
1. ShaderBinding。UE 新的渲染管线中用 ShaderBinding 替代了对 Shader 参数的设置。参考[[阅读笔记.UnrealEngine.渲染流程与数据组织框架#shaderbindings]]
# 绘制流程
...
# [[Shader 绑定|阅读笔记.UnrealEngine.渲染流程与数据组织框架.shader-bindings]]

# [[FVertexFactory | 阅读笔记.UnrealEngine.渲染流程与数据组织框架.vertex-factory]]
...
[[阅读笔记.UnrealEngine.渲染流程与数据组织框架.Buffer 对象]]
